...
label = ['2D', 'Ripple']
col = ['k', 'r']
f=a5.Ascot('/home/vallar/ASCOT/runs/SA_003/3D/PNB/ascot.h5')
wall = f.wall.wall_2D_3851912840.read()
rw = wall['R']; zw=wall['z']
# 3D field
# 0340564545, particle-1806163758, 100 mrkrs, new plasma profiles, wocollisions, gyroorbits, traj
# 0351002336, particle-1806163758, 100 mrkrs, new plasma profiles, wocollisions, gyroorbits, traj, better resolution
# 1731676910, particle-1806163758, 100 mrkrs, new plasma profiles, wocollisions, gyroorbits, traj, better resolution, longer number of points
# run-1636061869, 30k markers, new plasma profiles, wocollisions, gyroorbits, traj
# run-1675166651, 30k markers, new plasma profiles, wcollisions, hybrid

# 2D field used is B_2DS-0461682159
# 1100463887, particle-1806163758, 100 mrkrs, new plasma profiles, wocollisions, gyroorbits, traj

runs=[f.run_1731676910]
